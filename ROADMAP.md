...
**Categoria FerramentaAnálise de RedeWireshark, NmapTestes de AplicaçãoBurp Suite, OWASP ZAPMonitoramento/SIEMSplunk, ELK StackEscaneamento de VulnerabilidadeNessus, Snyk (ótimo para código de SaaS)
